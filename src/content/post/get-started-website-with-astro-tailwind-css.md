...
author: John Smith
title: Get started with Purple Martin to create a website using Astro and Tailwind CSS
excerpt: Start your web journey with Purple Martin – harness Astro and Tailwind CSS for a stunning site. Explore our guide now.
